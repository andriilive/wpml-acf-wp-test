...
<div id="tpl-wpt-skype-edit-button">
    <div>
        ...
        <p><?php _e('Skype Name', PMTI_Plugin::TEXT_DOMAIN); ?></p>
            ...
            <div class="wpallimport-content-section rad4-bottom"
                ...
                <div class="wpallimport-collapsed-content" style="padding: 0; display: none;">
                    <div class="wpallimport-collapsed-content-inner">
                        ...
                        <p><?php _e('Choose what you\'d like your button to do.', PMTI_Plugin::TEXT_DOMAIN); ?></p>
                        ...
                        <p style="margin-top: 30px;"><?php _e('Choose how you want your button to look.', PMTI_Plugin::TEXT_DOMAIN); ?></p>
                        ...
                        <select class="js-wpt-skype js-wpt-skype-size wpt-form-select form-select select"
                                data-wpt-type="select"
